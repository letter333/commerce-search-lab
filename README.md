...
현재는 개발·검색 평가 하네스, Elasticsearch·Nori 9.4.7 로컬 기동과 공식 Java Client의 TLS·인증 연결이 준비되어 있다. 다음 단계는 실제 엔진 테스트의 인덱스 격리다. 검색 API와 상품 색인은 아직 구현하지 않았다. 상품 50개와 시나리오 30개는 가상 개발 시드다.
...
- [Java Client 설정과 실제 엔진 통합 테스트](docs/java-client-setup.md)
